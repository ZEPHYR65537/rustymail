...
完整设计仍待逐项验收。L0 已落地 ADR 002/003 的基础路径，并增加进程故障验证；不等于完成生产耐久性与全部功能。实际差异见[实现教程](10-first-implementation.md)，依赖见[清单](../reports/0.1.0-lab/dependencies.md)。重要变更需记录原因，不让代码、教程和运维文档各说各话。
